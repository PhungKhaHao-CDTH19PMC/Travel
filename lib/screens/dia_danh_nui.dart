...
class Nui extends StatefulWidget {
  String username;
  Nui({Key? key, required this.username}) : super(key: key);

  @override
  _NuiState createState() => _NuiState();
}
int _iApi=0;
String _urlFind = "http://10.0.2.2:8000/doan/api/tim_kiem.php/?find=";
String _iUrl="";
class _NuiState extends State<Nui> {
  Iterable s = [];
  bool isUpdate = true;
...
Widget detail(int index){
  ...
  Widget build(BuildContext context) {
    API(url: "http://10.0.2.2:8000/doan/api/lay_dia_danh_nui.php")
          .getDataString()
          .then((value) {
          s = json.decode(value);
          isUpdate = false;
