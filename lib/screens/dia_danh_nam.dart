...
class Nam extends StatefulWidget {
  String username;
  Nam({Key? key, required this.username}) : super(key: key);

  @override
  _NamState createState() => _NamState();
}
int _iApi=0;
...
Widget detail(int index){
  ...
  Widget build(BuildContext context) {
    API(url: "http://10.0.2.2:8000/doan/api/lay_dia_danh_nam.php")
          .getDataString()
          .then((value) {
          s = json.decode(value);
          isUpdate = false;
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Địa điểm ở miền nam'),
      ),
      body: ListView(
        children: [
        buildList()
