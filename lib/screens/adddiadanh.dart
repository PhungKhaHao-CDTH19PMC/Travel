...
class _AddScreenState extends State<AddScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Form thêm địa danh'),),
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            OutlinedButton(
                ...
                onPressed: () {
                  if (name.text == '' || linkanh.text == '' || location1.text == ''|| location2.text == ''|| description.text == '') {
                    c = 'Vui lòng nhập đầy đủ thông tin';
                  } else {
                    c = '';
                    API(
                            url:
                                "http://10.0.2.2:8000/doan/api/themdiadanh.php?name=" +
                                    name.text +
                                    "&imagepath=" +
                                    linkanh.text +
                                    "&location1=" +
